package br.senac.go.repository.ui;
...
import br.senac.go.repository.R;
import br.senac.go.repository.data.model.User;
import br.senac.go.repository.data.repository.IUserRepository;
import br.senac.go.repository.data.repository.UserRepository;
import br.senac.go.repository.data.repository.source.UserMemorySourceImpl;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		userRepository = new UserRepository(new UserMemorySourceImpl());
	}
	...
	private class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
		...
		private class ViewHolder extends RecyclerView.ViewHolder {
			...
			public void bind(User user, int position) {
				tv.setText(user.getNome() + " " + user.getSobrenome());
			}
		}
	}
}
